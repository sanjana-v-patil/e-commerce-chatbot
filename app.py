...
try:
    ...
    print("⚠️ OpenAI API key not found in secrets. Please enter it manually:")
...
# ============================================================================
print("\n📊 Creating data summaries for RAG...")
...
print(f"✅ Created {len(documents)} documentation chunks")
...
print("\n🔍 Installing and setting up free embeddings...")
...
print(f"📊 Stored {len(documents)} document chunks in the vector store")
...
print("⚙️ Setting up Gemini-powered multi-agent system...")
...
- 👥 Providing customer insights and demographics
- 📦 Examining product catalogs and categories
- ⭐ Evaluating customer reviews and satisfaction
- 🧠 Offering business recommendations
...
# ----------------------------------------------------------------------------
# 5️⃣ Create conversational memory
# ----------------------------------------------------------------------------
...
print("✅ Gemini-based conversational agent created (single-response mode).")
...
print("\n💬 Launching Console Chat Interface with Gemini (Stable Single-Response Mode)...")
print("="*70)
print("🛍 Maersk E-commerce AI Agent (Gemini 2.5 Pro - Free Tier)")
print("Ask me about:")
print("- 📊 Sales trends and revenue")
print("- 👥 Customer demographics and location")
print("- 📦 Product categories and inventory")
print("- ⭐ Customer reviews and satisfaction")
...
while True:
    ...
    try:
        # Directly query the Gemini model once — skip ReAct parsing
...
# ======================================================================
# 💬 Maersk E-commerce AI Agent + Gradio UI (Gemini 2.5 Pro - Free Tier)
# ======================================================================
...
# ----------------------------------------------------------------------
# 2️⃣ Console Chat Interface (unchanged)
# ----------------------------------------------------------------------
print("\n💬 Launching Console Chat Interface with Gemini (Stable Single-Response Mode)...")
print("="*70)
print("🛍 Maersk E-commerce AI Agent (Gemini 2.5 Pro - Free Tier)")
...
# ----------------------------------------------------------------------
# 3️⃣ Function to handle Gemini responses (fixed for Gradio)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 4️⃣ Console chat loop (keep as is)
# ----------------------------------------------------------------------
def run_console():
    while True:
        user_input = input("🧑 You: ").strip()
...
# ----------------------------------------------------------------------
# 5️⃣ Gradio UI (Colab Compatible)
# ----------------------------------------------------------------------
def launch_gradio_ui():
    chatbot = gr.ChatInterface(
        fn=gemini_chat,
        title="🛍 Maersk E-commerce AI Agent",
        description=(
